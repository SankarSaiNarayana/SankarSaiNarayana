...
<p align="center">
  Supported AI-powered customer engagement platforms serving enterprise-scale conversational workloads.
</p>
...
<table align="center">
  <tr>
    <td valign="top" width="50%">
      ...
      <p align="center">
        RAG Pipelines &middot; LangChain &middot; LangGraph<br/>
        AI Agents &middot; Prompt Engineering<br/>
        Vector Databases &middot; Workflow Automation
      </p>
    </td>
    <td valign="top" width="50%">
      <h3 align="center">Voice &amp; Speech AI</h3>
      <p align="center">
        Speech-to-Text (Whisper, Deepgram)<br/>
        Text-to-Speech (ElevenLabs)<br/>
        Realtime / streaming voice &middot; Low-latency audio
      </p>
    </td>
  </tr>
  <tr>
    <td valign="top" width="50%">
      ...
      <p align="center">
        AWS (EKS, IAM, EC2, EBS)<br/>
        Kubernetes &middot; Docker<br/>
        CI/CD &middot; GitHub Actions &middot; IaC
      </p>
    </td>
    <td valign="top" width="50%">
      <h3 align="center">Reliability &amp; Ops</h3>
      <p align="center">
        SRE Practices &middot; Incident Response<br/>
        Observability (Grafana, Prometheus)<br/>
        Root-Cause &amp; Log / Metrics Analysis
      </p>
    </td>
  </tr>
</table>
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=python,typescript,javascript,sql,bash"/>
</p>
...
<table align="center">
  <tr>
    <td valign="top" width="33%">
      <h3 align="center">KubeAtlas</h3>
      <p align="center">
        Intelligent Kubernetes troubleshooting platform that collects real-time
        cluster context and uses LLMs to investigate failures and recommend fixes &mdash;
    ...
    <td valign="top" width="33%">
      <h3 align="center">Self-Healing RAG</h3>
      <p align="center">
        Retrieval-Augmented Generation system that improves retrieval quality
        dynamically &mdash; semantic search, adaptive pipelines, and knowledge-aware
    ...
    <td valign="top" width="33%">
      <h3 align="center">Cloud-Native EKS</h3>
      <p align="center">
        Production-style AWS deployments on EKS &mdash; persistent EBS storage,
        ingress + TLS, and IAM-based security, built with scalability and
